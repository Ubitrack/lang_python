...
UBITRACK_REGISTER_COMPONENT( Dataflow::ComponentFactory* const cf ) {
	// Pose * Pose = Pose
	cf->registerComponent< MultiplicationComponent< Measurement::Pose, Measurement::Pose, Measurement::Pose > > ( "PoseMultiplication1" );

	// ErrorPose * ErrorPose = ErrorPose
	cf->registerComponent< MultiplicationComponent< Measurement::ErrorPose, Measurement::ErrorPose, Measurement::ErrorPose > > ( "ErrorPoseMultiplication1" );

	// Pose * ErrorPose = ErrorPose
	cf->registerComponent< MultiplicationComponent< Measurement::Pose, Measurement::ErrorPose, Measurement::ErrorPose > > ( "PoseErrorPoseMultiplication1" );

	// ErrorPose * Pose = ErrorPose
	cf->registerComponent< MultiplicationComponent< Measurement::ErrorPose, Measurement::Pose, Measurement::ErrorPose > > ( "ErrorPosePoseMultiplication1" );

	// Rotation * Rotation = Rotation
	cf->registerComponent< MultiplicationComponent< Measurement::Rotation, Measurement::Rotation, Measurement::Rotation > > ( "RotationMultiplication1" );

	// Pose * Position = Position
	cf->registerComponent< MultiplicationComponent< Measurement::Pose, Measurement::Position, Measurement::Position > > ( "PosePositionMultiplication1" );

	// Position * Position = Position
	cf->registerComponent< MultiplicationComponent< Measurement::Position, Measurement::Position, Measurement::Position > > ( "PositionMultiplication1" );

	// ErrorPose * Position = ErrorPosition
	cf->registerComponent< MultiplicationComponent< Measurement::ErrorPose, Measurement::Position, Measurement::ErrorPosition > > ( "ErrorPosePositionMultiplication1" );

	// Pose * PositionList = PositionList
	cf->registerComponent< MultiplicationComponent< Measurement::Pose, Measurement::PositionList, Measurement::PositionList > > ( "PosePositionListMultiplication1" );

	// Pose * PoseList = PoseList
	cf->registerComponent< MultiplicationComponent< Measurement::Pose, Measurement::PoseList, Measurement::PoseList > > ( "PosePoseListMultiplication1" );

	// PoseList * Pose = PoseList
	cf->registerComponent< MultiplicationComponent< Measurement::PoseList, Measurement::Pose, Measurement::PoseList > > ( "PoseListPoseMultiplication1" );

	// Rotation * RotationVelocity = RotationVelocity
	cf->registerComponent< MultiplicationComponent< Measurement::Rotation, Measurement::RotationVelocity, Measurement::RotationVelocity > > ( "RotationVelocityMultiplication1" );
	
	// Rotation * RotationVelocity = RotationVelocity
	cf->registerComponent< MultiplicationComponent< Measurement::Pose, Measurement::ErrorPositionList, Measurement::ErrorPositionList > > ( "PoseErrorPositionListMultiplication1" );

	cf->registerComponent< MultiplicationComponent< Measurement::ErrorPose, Measurement::ErrorPosition, Measurement::ErrorPosition > > ( "ErrorPoseErrorPositionMultiplication1" );
